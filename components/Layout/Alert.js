export default function IndexPage() {
  return (
    <div>
      <div className="cursor-pointer  lg:text-lg font-futura w-full flex mx-auto justify-center text-center items-center h-8 bg-th-background text-primary-dark">
        <div className="cursor-pointer text-base lg:text-lg font-futura font-thin w-full flex mx-auto justify-center text-center items-center h-8 bg-th-accent-light text-white ">
          <div className="border px-4 mt-0.5 mb-0.5 -pt-1 -pb-10 animate-pulse flex items-center rounded-full">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
            ...
            <p className="translate-y-0.5 font-thin">
              ANTHROPOS TOKEN DROP NOW LIVE!
            </p>
          </div>
        </div>
      </div>
